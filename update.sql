...
ALTER TABLE `md_siswa` CHANGE `NOHP_SISWA` `NOHP_SISWA` BIGINT(13) UNSIGNED ZEROFILL NULL DEFAULT NULL;
SET FOREIGN_KEY_CHECKS=0;
UPDATE md_siswa SET NISN_SISWA=NULL;
ALTER TABLE `md_siswa` CHANGE `NISN_SISWA` `NISN_SISWA` INT(10) UNSIGNED ZEROFILL NULL DEFAULT NULL;
