...
ALTER TABLE `bk_soal` ADD UNIQUE( `KATEGORI_BKSOAL`, `URUTAN_BKSOAL`);
ALTER TABLE `bk_dcm` ADD UNIQUE( `TA_DCM`, `SISWA_DCM`, `SOAL_DCM`);
INSERT INTO `simapes`.`md_menu` (`ID_MENU`, `NAME_MENU`, `CONTROLLER_MENU`, `FUNCTION_MENU`, `SHOW_MENU`, `LEVEL_CHILD`, `HAVE_CHILD`) VALUES ('01406001003', 'DCM - DELETE', 'bk/laporan_dcm', 'delete', '0', '2', '0');
INSERT INTO `simapes`.`md_levelmenu` (`MENU_LEVELMENU`, `HAKAKSES_LEVELMENU`) VALUES ('01406001003', '14');
