...
class Cetak_kartu extends CI_Controller {
    ...
    public function cetak_all() {
        ...
        if(!isset($input['tingkat'])) {
            ...
            if($input['blanko'] == 2) $bulan = json_decode($input['bulan'], TRUE);
        } else {
        ...
        if($input['blanko'] == 0) $view = 'cetak_bukti';
        elseif($input['blanko'] == 1) $view = 'cetak_blanko';
        elseif($input['blanko'] == 2) $view = 'cetak_monitoring';
