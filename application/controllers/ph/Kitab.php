...
class Kitab extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('kitab_model', 'kitab');
        $this->auth->validation(5);
    }

    public function index() {
        $this->generate->backend_view('ph/kitab/index');
    }
            ...
            $row[] = '
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="javascript:void()" title="Ubah" onclick="update_data_' . $id_datatables . '(\'' . $item->ID_KITAB . '\')"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Ubah</a></li>
                        <li><a href="javascript:void()" title="Hapus" onclick="delete_data_' . $id_datatables . '(\'' . $item->ID_KITAB . '\')"><i class="fa fa-trash"></i>&nbsp;&nbsp;Hapus</a></li>
                    </ul>
                </div>';
    ...
    public function request_form() {
        $data = $this->generate->set_header_form_JSON($this->kitab);
    ...
    public function ajax_delete() {
        ...
        $affected_row = $this->kitab->delete_by_id($id);
    ...
    public function auto_complete() {
        ...
        $data = $this->kitab->get_all_ac($this->input->post('q'));
