...
class Laporan_tindakan extends CI_Controller {
    ...
    public function ajax_list() {
        ...
        foreach ($list as $item) {
            ...
            $row[] = '<a href="'. site_url('komdis/laporan_poin/cetak_surat/'.$item->ID_KT).'" target="_blank"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-print"></i>&nbsp;&nbsp;'.$item->NAMA_KJT.'</button></a>';
