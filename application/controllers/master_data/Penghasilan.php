...
class Penghasilan extends CI_Controller {
    ...
    public function index() {
        $this->generate->backend_view('master_data/penghasilan/index');
    }
            ...
            $row[] = '
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="javascript:void()" title="Ubah" onclick="update_data_' . $id_datatables . '(\'' . $item->ID_HASIL . '\')"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Ubah</a></li>
                        <li><a href="javascript:void()" title="Hapus" onclick="delete_data_' . $id_datatables . '(\'' . $item->ID_HASIL . '\')"><i class="fa fa-trash"></i>&nbsp;&nbsp;Hapus</a></li>
                    </ul>
                </div>';
    ...
    public function request_form() {
        $data = $this->generate->set_header_form_JSON($this->penghasilan);
        ...
        $data_html = array(
            array(
                ...
                'data' => array(
                    ...
                    'name' => 'NAMA_HASIL',
                    "placeholder" => " ",
                    'value' => $data == NULL ? "" : $data->NAMA_HASIL
                )
            )
        );
    ...
    public function ajax_add() {
        ...
        $insert = $this->penghasilan->save($data);
    ...
    public function ajax_update() {
        ...
        $data['NAMA_HASIL'] = $this->input->post('NAMA_HASIL');
        
        $affected_row = $this->penghasilan->update($where, $data);
    ...
    public function ajax_delete() {
        ...
        $affected_row = $this->penghasilan->delete_by_id($id);
