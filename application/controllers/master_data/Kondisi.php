...
class Kondisi extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('kondisi_model', 'kondisi');
        $this->auth->validation(11);
    }

    public function index() {
        $this->generate->backend_view('master_data/kondisi/index');
    }
            ...
            $row[] = '
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="javascript:void()" title="Ubah" onclick="update_data_' . $id_datatables . '(\'' . $item->ID_KONDISI . '\')"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Ubah</a></li>
                        <li><a href="javascript:void()" title="Hapus" onclick="delete_data_' . $id_datatables . '(\'' . $item->ID_KONDISI . '\')"><i class="fa fa-trash"></i>&nbsp;&nbsp;Hapus</a></li>
                    </ul>
                </div>';
    ...
    public function request_form() {
        $data = $this->generate->set_header_form_JSON($this->kondisi);
        ...
        $data_html = array(
            array(
                ...
                'data' => array(
                    ...
                    'name' => 'NAMA_KONDISI',
                    "placeholder" => " ",
                    'value' => $data == NULL ? "" : $data->NAMA_KONDISI
                )
            )
        );
    ...
    public function ajax_update() {
        ...
        $data['NAMA_KONDISI'] = $this->input->post('NAMA_KONDISI');
        
        $affected_row = $this->kondisi->update($where, $data);
    ...
    public function ajax_delete() {
        ...
        $affected_row = $this->kondisi->delete_by_id($id);
