...
class Pegawai extends CI_Controller {
    ...
    public function index() {
        $this->generate->backend_view('laporan/pegawai/index');
    }
    ...
    public function get_data() {
        ...
        $data_peg = $this->pegawai->get_data($exp_kelompok[0], $keaktifan);
    ...
    public function export($keaktifan = "") {
        ...
        header("Content-Disposition: attachment; filename=data_pegawai_".$status."_" . date('Y-m-d_H-i-s') . ".csv");

        echo $this->pegawai->export_data($keaktifan);
    }
