        ...
        <link href="<?php echo base_url(); ?>assets/vendor/select2-3.5.2/select2.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo base_url(); ?>assets/vendor/select2-bootstrap/select2-bootstrap.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo base_url(); ?>assets/vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css" rel="stylesheet" type="text/css"/>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/photobooth/photobooth.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/xeditable/bootstrap3-editable/css/bootstrap-editable.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/fullcalendar-3.2.0/fullcalendar.min.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/fullcalendar-3.2.0/fullcalendar.print.css" media='print'/>
        ...
        <script src="<?php echo base_url(); ?>assets/vendor/moment/moment.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/select2-3.5.2/select2.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/vendor/jquery-validation/jquery.validate.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/bootstrap-datepicker-master/dist/js/bootstrap-datepicker.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/clockpicker/dist/bootstrap-clockpicker.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/vendor/photobooth/photobooth_min.js"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/fileupload/ajaxfileupload.js"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/xeditable/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/fullcalendar-3.2.0/fullcalendar.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/vendor/fullcalendar-3.2.0/locale-all.js"></script>
    ...
    <body class="fixed-navbar fixed-sidebar">
        ...
        <div class="splash-screen">
            <div class="splash"> <div class="color-line"></div><div class="splash-title"><h1><?php echo config_item("app_name"); ?></h1><?php echo config_item("motto"); ?> </p><div class="spinner"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div> </div> </div>
        </div>
        <!--[if lt IE 7]>
