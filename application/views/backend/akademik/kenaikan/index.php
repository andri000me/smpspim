...
<script type="text/javascript">
    ...
    var functionAddData = function (e, dt, node, config) {
        if(!(KELAS_FILTER === null)) window.open('<?php echo site_url('akademik/rapor'); ?>/');
    };
...
<?php } ?>
    ...
    function tetapkan_filter(proses) {
        ...
        if (KELAS_FILTER === '' || ID_PEG === null || NEXT_TA_FILTER === null) {
            ...
            if(proses) list_nilai(KELAS_FILTER);
            else list_siswa(KELAS_FILTER);
        }
    }
    ...
    function proses_naik(that) {
        ...
        var action = function(isConfirm) {
            if(isConfirm) {
                ...
                create_ajax('<?php echo site_url('akademik/kenaikan/proses_naik'); ?>', 'ID_AS=' + ID_AS + '&STATUS_KENAIKAN=' + STATUS_KENAIKAN + '&NEXT_TA_FILTER=' + NEXT_TA_FILTER, success);
            }
        };
