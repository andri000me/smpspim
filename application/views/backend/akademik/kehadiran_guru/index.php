...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('<div class="btn-group"><button data-toggle="dropdown" class="btn btn-default btn-sm dropdown-toggle">Cetak <span class="caret"></span></button><ul class="dropdown-menu"><li><a href="#" onclick="cetak_kehadiran();">Cetak Daftar Kehadiran</a></li><li><a href="<?php echo site_url('akademik/kehadiran_guru/laporan_kehadiran'); ?>" target="_blank">Cetak Laporan Kehadiran</a></li></ul></div>').insertAfter('.buttons-add');
    });
