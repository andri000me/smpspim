...
<div class="content animate-panel">
    ...
    ?>
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel collapsed collapsed-panel hblue">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel collapsed collapsed-panel hgreen">
                    <div class="panel-heading hbuilt">
                        <div class="panel-tools">
                            <a  class="showhide" onclick="togglePanel(this);"><i class="fa fa-chevron-up"></i></a>
                            <a class="closebox"><i class="fa fa-times"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel collapsed collapsed-panel hviolet">
                    <div class="panel-heading hbuilt">
                        <div class="panel-tools">
                            <a  class="showhide" onclick="togglePanel(this);"><i class="fa fa-chevron-up"></i></a>
                            <a class="closebox"><i class="fa fa-times"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel collapsed collapsed-panel hyellow">
                    <div class="panel-heading hbuilt">
                        <div class="panel-tools">
                            <a  class="showhide" onclick="togglePanel(this);"><i class="fa fa-chevron-up"></i></a>
                            <a class="closebox"><i class="fa fa-times"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel collapsed collapsed-panel hred">
                    <div class="panel-heading hbuilt">
                        <div class="panel-tools">
                            <a  class="showhide" onclick="togglePanel(this);"><i class="fa fa-chevron-up"></i></a>
                            <a class="closebox"><i class="fa fa-times"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel collapsed collapsed-panel hreddeep">
                    <div class="panel-heading hbuilt">
                        <div class="panel-tools">
                            <a  class="showhide" onclick="togglePanel(this);"><i class="fa fa-chevron-up"></i></a>
                            <a class="closebox"><i class="fa fa-times"></i></a>
...
<script type="text/javascript">
    ...
    function togglePanel(that) {
        $(".collapsed-panel").not($(that).parent().parent().parent()).addClass('collapsed');
    }
</script>
