...
<div class="content animate-panel">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <h4><?php echo $this->session->userdata('NAMA_CAWU_ACTIVE'); ?> | TAHUN AJARAN <?php echo $this->session->userdata('NAMA_TA_ACTIVE'); ?> | PSB <?php echo $this->session->userdata('NAMA_PSB_ACTIVE'); ?></h4>
            </div>
            <div class="col-md-2">
