...
<body class="fixed-navbar fixed-sidebar">
    ...
    <div class="content animate-panel" style="padding-bottom: 0px;">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <a href="#" class="pull-right" title="Klik untuk melihat detail" onclick="return toggleDetail();;">
                    <i class="pe-7s-angle-down-circle" style="font-size: 40px; margin-left: 30px;"></i>
                </a>
    ...
    <div class="content animate-panel ringkasan-siswa" style="padding-top: 0px;">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 border-right">
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php list_detail('NAMA AYAH', $SISWA->AYAH_NAMA_SISWA); ?>
                                        <?php list_detail('NO HP', $SISWA->ORTU_NOHP1_SISWA); ?>
                                    </div>
                                    <div class="col-md-6 text-right">                                        
                                        <?php list_detail('NAMA IBU', $SISWA->IBU_NAMA_SISWA); ?>
                                    </div>
                                    <div class="col-md-12">
    ...
    <div class="content animate-panel detail-siswa" style="padding-top: 0px;">
        <br>
        <?php
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="hpanel hviolet">
                                        ...
                                        <div class="panel-body">
                                            <?php if (count($DETAIL['POIN_DETAIL']) > 0) { ?>
                                                <div class="row" onmouseover="highlight_row(this);" onmouseout="remove_highlight(this);">
                                                    <div class="col-md-4">
                                                        <div class="list-item">
                                                ...
                                                <?php foreach ($DETAIL['POIN_DETAIL'] as $POIN_DETAIL) { ?>
                                                    <div class="row" onmouseover="highlight_row(this);" onmouseout="remove_highlight(this);">
                                                        <div class="col-md-2">
                                                            <div class="list-item">
                                                ...
                                                <?php if (count($DETAIL['TINDAKAN']) > 0) { ?>
                                                    ...
                                                    <?php foreach ($DETAIL['TINDAKAN'] as $TINDAKAN) { ?>
                                                        <div class="row" onmouseover="highlight_row(this);" onmouseout="remove_highlight(this);">
                                                            <div class="col-md-2">
                                                                <div class="list-item">
                                    ...
                                    <div class="hpanel hviolet">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            if (count($DETAIL['KEUANGAN']) > 0) {
                                                ...
                                                <?php
                                                foreach ($DETAIL['KEUANGAN'] as $DETAIL_KEUANGAN) {
    ...
    <script type="text/javascript">
        ...
        function toggleDetail() {
            if (toggleDetailRow) {
                $(".ringkasan-siswa").slideDown();
                $(".detail-siswa").slideUp();
            } else {
                $(".detail-siswa").slideDown();
                $(".ringkasan-siswa").slideUp();
            }
