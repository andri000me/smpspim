            ...
            <div class="col-md-12">
                <div class="hpanel hblue">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->generate->input_text('KK', array('name' => 'KK_PEG', 'maxlength' => 16, 'value' => $mode_edit ? $data->KK_PEG : '', 'value' => $mode_edit ? $data->KK_PEG : '', 'id' => 'KK_PEG', 'onchange' => 'return check_data(\'KK_PEG\');'), FALSE, 4); ?>
                        ...
                        $this->generate->input_dropdown('Status Menikah', 'MENIKAH_PEG', array(
                            array('id' => 'BELUM', 'text' => 'BELUM MENIKAH', 'selected' => $mode_edit ? ($data->MENIKAH_PEG == 'BELUM' ? TRUE : FALSE) : FALSE),
                            array('id' => 'SUDAH', 'text' => 'SUDAH MENIKAH', 'selected' => $mode_edit ? ($data->MENIKAH_PEG == 'SUDAH' ? TRUE : FALSE) : FALSE),
                                ), FALSE, 3);
                        ?>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="hpanel hblue">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->generate->input_text('No. HP 2', array('name' => 'NOHP1_PEG', 'maxlength' => 12, 'value' => $mode_edit ? $data->NOHP1_PEG : ''), FALSE, 4); ?>
