<?php
$title = 'Jenis Kegiatan Absensi';
$subtitle = "Daftar semua jenis kegiatan absensi";
$id_datatables = 'datatable1';

$columns = array(
    'ID',
    'NAMA',
    'ID PELANGGARAN ALPHA',
    'NAMA PELANGGARAN ALPHA',
    'POIN PELANGGARAN ALPHA',
    'ID PELANGGARAN TERLAMBAT',
    'NAMA PELANGGARAN TERLAMBAT',
    'POIN PELANGGARAN TERLAMBAT',
    'AKSI',
);
...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('master_data/jenis_absensi/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('master_data/jenis_absensi/ajax_add'); ?>';
    var url_update = '<?php echo site_url('master_data/jenis_absensi/ajax_update'); ?>';
    var url_form = '<?php echo site_url('master_data/jenis_absensi/request_form'); ?>';
    ...
    $(document).ready(function () {
        table = initialize_datatables(id_table, '<?php echo site_url('master_data/jenis_absensi/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
