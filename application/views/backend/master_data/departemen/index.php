<?php
$title = 'Departemen';
$subtitle = "Daftar semua departemen";
...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('master_data/departemen/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('master_data/departemen/ajax_add'); ?>';
    var url_update = '<?php echo site_url('master_data/departemen/ajax_update'); ?>';
    var url_form = '<?php echo site_url('master_data/departemen/request_form'); ?>';
    ...
    var functionAddData = function (e, dt, node, config) {
        create_homer_info("Anda tidak diperbolehkan menambah data pada menu ini.");
//        create_form_input(id_form, id_modal, url_form, title, null);
    };

    $(document).ready(function () {
        table = initialize_datatables(id_table, '<?php echo site_url('master_data/departemen/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    });
