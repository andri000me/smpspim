...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('master_data/hari/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('master_data/hari/ajax_add'); ?>';
    var url_update = '<?php echo site_url('master_data/hari/ajax_update'); ?>';
    var url_form = '<?php echo site_url('master_data/hari/request_form'); ?>';
