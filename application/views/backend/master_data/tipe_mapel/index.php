...
$subtitle = "Daftar semua tipe mata pelajaran";
...
$columns = array(
    ...
    'NILAI MINIMAL HER',
    'NILAI MINIMAL TAMAT',
    'NILAI MINIMAL TIDAK TAMAT',
    'NILAI MINIMAL NAIK KELAS',
    'AKSI',
);
...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('master_data/tipe_mapel/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('master_data/tipe_mapel/ajax_add'); ?>';
    var url_update = '<?php echo site_url('master_data/tipe_mapel/ajax_update'); ?>';
    var url_form = '<?php echo site_url('master_data/tipe_mapel/request_form'); ?>';
...
//        create_form_input(id_form, id_modal, url_form, title, null);
    ...
    $(document).ready(function () {
        table = initialize_datatables(id_table, '<?php echo site_url('master_data/tipe_mapel/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
