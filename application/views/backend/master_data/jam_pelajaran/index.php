<?php
$title = 'Jam Pelajaran';
$subtitle = "Daftar semua jam pelajaran";
...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('master_data/jam_pelajaran/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('master_data/jam_pelajaran/ajax_add'); ?>';
    var url_update = '<?php echo site_url('master_data/jam_pelajaran/ajax_update'); ?>';
    var url_form = '<?php echo site_url('master_data/jam_pelajaran/request_form'); ?>';
    ...
    $(document).ready(function () {
        table = initialize_datatables(id_table, '<?php echo site_url('master_data/jam_pelajaran/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    });
