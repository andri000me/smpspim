<?php
$title = 'Status Kepala Keluarga';
$subtitle = "Daftar semua status kepala keluarga";
...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('master_data/status_kk/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('master_data/status_kk/ajax_add'); ?>';
    var url_update = '<?php echo site_url('master_data/status_kk/ajax_update'); ?>';
    var url_form = '<?php echo site_url('master_data/status_kk/request_form'); ?>';
    ...
    $(document).ready(function () {
        table = initialize_datatables(id_table, '<?php echo site_url('master_data/status_kk/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    });
