                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4">
                            <a href="#"  data-toggle="modal" data-target="#cetak_modal" onclick="set_type(3);"><button type="button" class="btn btn-success btn-block"><i class="fa fa-print"></i>&nbsp;&nbsp;Cetak Validasi Semua Siswa TA Aktif</button></a>
                        </div>
                    </div>
                </div>
            </div>
