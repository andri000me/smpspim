...
if(isset($title_view)) $title = $title_view;
            ...
            <div class="col-md-12">
                <div class="hpanel hblue">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->generate->input_radio('Jenis Kelamin', array('name' => 'JK_SISWA', 'inline' => true, 'checked' => $mode_edit ? $data->JK_SISWA : '', 'value' => $mode_edit ? [['value' => 'L', 'label' => 'Laki-laki'], ['value' => 'P', 'label' => 'Perempuan']] : [['value' => 'L', 'label' => 'Laki-laki'], ['value' => 'P', 'label' => 'Perempuan']]), TRUE, 9); ?>
                        ...
                        <?php $this->generate->input_select2('Tempat Tinggal', array('name' => 'TEMPAT_TINGGAL_SISWA', 'url' => site_url('psb/calon_siswa/ac_tinggal')), FALSE, 5, FALSE, $mode_edit ? array('id' => $data->TEMPAT_TINGGAL_SISWA, 'text' => $data->NAMA_TEMTING) : NULL); ?>
            ...
            <div class="col-md-12">
                <div class="hpanel hgreen">
                    ...
                    <div class="panel-body">
                        ...
                        <?php
                        if ($mode_edit && ($data->FOTO_SISWA != NULL)) {
                            echo '<hr><div class="row"><div class="col-md-12 text-center"><img src="' . base_url('files/siswa/' . $data->FOTO_SISWA) . '" width="400" /></div></div>';
                        }
                        ?>
                    </div>
                </div>
