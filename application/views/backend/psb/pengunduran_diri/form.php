...
$mode_edit ? $title = 'PENGEMBALIAN CALON SISWA KE PSB' : $title = 'Tambah Calon Siswa';
...
<div class="content animate-panel">
    ...
    if ($mode_edit)
        ...
        $this->generate->input_hidden('STATUS_PSB_SISWA', 1);
    ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel hblue">
                    ...
                    <div class="panel-body">
                        <?php $this->generate->input_text('NIK', array('name' => 'NIK_SISWA', 'maxlength' => 16, 'value' => $mode_edit ? $data->NIK_SISWA : '', 'value' => $mode_edit ? $data->NIK_SISWA : '', 'id' => 'NIK_SISWA', 'onchange' => 'return check_data(\'NIK_SISWA\');', 'readonly' => 'true'), TRUE, 4); ?>
                        <?php $this->generate->input_text('Nama Lengkap', array('name' => 'NAMA_SISWA', 'maxlength' => 100, 'value' => $mode_edit ? $data->NAMA_SISWA : '', 'readonly' => 'true'), TRUE); ?>
                        ...
                        <?php $this->generate->input_text('Tempat Lahir', array('name' => 'TEMPAT_LAHIR_SISWA', 'maxlength' => 150, 'value' => $mode_edit ? $data->TEMPAT_LAHIR_SISWA : '', 'readonly' => 'true'), TRUE, 4); ?>
                        <?php $this->generate->input_date('Tanggal Lahir', array('name' => 'TANGGAL_LAHIR_SISWA', 'value' => $mode_edit ? $this->date_format->to_view($data->TANGGAL_LAHIR_SISWA) : '', 'readonly' => 'true'), TRUE, 2); ?>
            ...
            <div class="col-md-12">
                <div class="hpanel hgreen">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->generate->input_select2('Masuk kejenjang', array('name' => 'MASUK_JENJANG_SISWA', 'url' => site_url('psb/calon_siswa/ac_jenjang_sekolah')), TRUE, 2, FALSE, NULL); ?>
                        <?php
                        $this->generate->input_dropdown('Masuk ketingkat', 'MASUK_TINGKAT_SISWA', array(
                            array('id' => 0, 'text' => "Pilih jenjang terlebih dahulu", 'selected' => TRUE),
                                ), TRUE, 4);
                        ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel hgreen">
                    ...
                    <div class="panel-body">
                        <?php $this->generate->input_text('Alamat', array('name' => 'ALAMAT_SISWA', 'maxlength' => 250, 'value' => $mode_edit ? $data->ALAMAT_SISWA : '', 'readonly' => 'true'), TRUE, 9); ?>
            ...
            <div class="col-md-12">
                <div class="hpanel hviolet">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->generate->input_text('Nama', array('name' => 'AYAH_NAMA_SISWA', 'maxlength' => 200, 'value' => $mode_edit ? $data->AYAH_NAMA_SISWA : '', 'readonly' => 'true'), TRUE); ?>
                        ...
                        <?php $this->generate->input_text('Tempat Lahir', array('name' => 'AYAH_TEMPAT_LAHIR_SISWA', 'maxlength' => 150, 'value' => $mode_edit ? $data->AYAH_TEMPAT_LAHIR_SISWA : '', 'readonly' => 'true'), TRUE, 4); ?>
                        <?php $this->generate->input_date('Tanggal Lahir', array('name' => 'AYAH_TANGGAL_LAHIR_SISWA', 'value' => $mode_edit ? $this->date_format->to_view($data->AYAH_TANGGAL_LAHIR_SISWA) : '', 'readonly' => 'true'), TRUE, 2); ?>
...
<!--        <div class="row">
    ...
    $(function () {
        ...
        $(".js-source-states-JK_SISWA").select2("enable", false);
        $(".js-source-states-KECAMATAN_SISWA").select2("enable", false);
...
//        create_homer_error('PSB telah ditutup. Anda tidak diperbolehkan merubah data Masuk kejenjang dan Masuk ketingkat.');
            ...
            var success = function (data) {
                if (data.status) {
                    if ($("#from_upload").val() == 1) {
                        ...
                        remove_splash();
                        create_swal_success('', 'Data berhasil disimpan. Halaman ini akan otomatis tertutup.');
    ...
    <?php if ($mode_edit) { ?>create_form_ajax('<?php echo site_url('psb/pengunduran_diri/ajax_update') ?>', id, success, message);
