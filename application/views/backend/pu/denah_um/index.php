...
if (!$STATUS_PSB) {
            ...
            <div class="col-md-12">
                <div class="hpanel hbggreen">
                    <div class="panel-body">
                        <h1 class="text-center">ANDA TIDAK DIPERBOLEHKAN MENGAKSES DENAH SELAMA PSB MASIH DIBUKA.</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        var functionAddData = function (e, dt, node, config) {
            ...
            create_swal_option('Apakah Anda yakin melanjutkan?', 'Pembuatan denah akan menutup selamanya proses pendaftaran Siswa Baru. Sistem akan mengecek denah pada Tahun Ajaran aktif. Jika denah telah dibuat, Anda tidak dapat membuat denah baru melainkan merubah denah yang telah ada.', action);
        };
