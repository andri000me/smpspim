...
for ($i = 0; $i < count($siswa); $i++) {
    ...
    $pdf->Image($foto_siswa, $start_x + $offset_x, $posisi_y + $offset_y, $width_photo-4.25, $height_photo, '', '');
    if ($isset) $pdf->Image($foto_siswa, $start_x + $margin_right + $offset_x, $posisi_y + $offset_y, $width_photo-4.25, $height_photo, '', '');
