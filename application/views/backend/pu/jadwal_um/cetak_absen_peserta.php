...
foreach ($data as $detail) {
    ...
    foreach ($denah as $jk => $data_denah) {
        ...
        foreach ($data_denah['DENAH'] as $ruang => $value) {
            ...
            $pdf->Cell(0, 4, 'DAFTAR HADIR PESERTA UJIAN MASUK '.$nama_jk, 0, 0, 'C');
            $pdf->Ln();
            ...
            $pdf->Cell(0, 4, ': '.$this->time_format->jam_menit($detail['JAM_MULAI']).' - '.$this->time_format->jam_menit($detail['JAM_SELESAI']).' WIS', 0, 0, 'L');
            $pdf->Ln();
