    ...
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs">
                JADWAL TESTING QURAN
            </h2>
            <small>Jadwal untuk testing baca quran</small>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="hpanel hblue">
                <div class="panel-body text-center">
                    <a href="<?php echo site_url('pu/quran/form_aturan/1'); ?>" class="btn btn-primary">Ubah Aturan Jadwal</a>
                    <a href="<?php echo site_url('pu/quran/form_aturan/0'); ?>" class="btn btn-info">Ubah Jadwal</a>
                    <!--<a href="" class="btn btn-success" data-toggle="modal" data-target="#modal-cetak">Export Jadwal</a>-->
                    <a href="<?php echo site_url('pu/quran/cetak'); ?>" class="btn btn-success">Export Jadwal</a>
                    <a href="<?php echo site_url('pu/quran/reset_jadwal'); ?>" onclick="return confirm('Apakah Anda yakin menghapus jadwal?');" class="btn btn-danger">Hapus Jadwal</a>
                    <a href="<?php echo site_url('pu/quran/input_nilai'); ?>" class="btn btn-primary2">Nilai Testing</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function cetak_jadwal() {
        ...
        if(DIREKTUR === "" || PD === "" || KETUA === "")
            ...
            window.open('<?php echo site_url('pu/quran/cetak_denah'); ?>/' + DIREKTUR + "/" + PD + "/" + KETUA);
    }
