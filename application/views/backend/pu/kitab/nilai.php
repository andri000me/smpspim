<?php
$title = 'Nilai Testing Kitab';
$subtitle = "Daftar semua siswa yang akan mengikuti testing kitab";
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = initialize_datatables(id_table2, '<?php echo site_url('pu/kitab/ajax_list_kitab'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    ...
    function simpan_nilai(that) {
        ...
        if(isNaN(parseFloat(NILAI_TN))) {
            ...
            $(that).hide();
            create_ajax('<?php echo site_url('pu/kitab/simpan_nilai'); ?>', 'SISWA_TN=' + SISWA_TN + "&NILAI_TN=" + NILAI_TN, success);
        }
    }
</script>