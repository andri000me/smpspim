...
<div class="small-header transition animated fadeIn">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small>Form pembayaran siswa</small>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(".js-source-states-input").select2({
        ...
        ajax: {
            url: '<?php echo site_url('keuangan/pembayaran/ac_siswa'); ?>',
            dataType: "json",
            type: "POST",
            delay: 100,
            cache: true,
    ...
    function input_format(t) {
        ...
        if (NOMINAL <= TOTAL_TAGIHAN) {
            ...
            create_homer_error("Nominal pembayaran tidak boleh lebih dari total tagihan");
            $(t).val(NOMINAL);
        }
    }
    ...
    function get_data_tagihan() {
        ...
        create_ajax('<?php echo site_url('keuangan/pembayaran/get_data_tagihan'); ?>', 'ID_SISWA=' + ID_SISWA, success_tag);
    }
    ...
    function show_data_tagihan(data) {
        ...
        $.each(data, function (item, detail) {
            ...
            var sisa_tagihan = parseFloat(detail.NOMINAL_DT) - parseFloat(detail.BAYAR_SETUP);
    ...
    function action_save_<?php echo $name_function; ?>(id) {
        ...
        create_form_ajax('<?php echo site_url('keuangan/pembayaran/ajax_add'); ?>', id, success, message);
    }
    ...
    function cetak_pembayaran(id) {
        ...
        newwin = window.open("<?php echo site_url('keuangan/pembayaran/ajax_cetak'); ?>/" + id, "windowname5", params);
        if (window.focus) {
            newwin.focus()
        }
        return false;
