...
<script type="text/javascript">
    var table;
    var url_delete = '<?php echo site_url('keuangan/tagihan/ajax_delete'); ?>/';
    var url_add = '<?php echo site_url('keuangan/tagihan/ajax_add'); ?>';
    var url_update = '<?php echo site_url('keuangan/tagihan/ajax_update'); ?>';
    var url_form = '<?php echo site_url('keuangan/tagihan/request_form'); ?>';
    ...
    $(document).ready(function () {
        table = initialize_datatables(id_table, '<?php echo site_url('keuangan/tagihan/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    });
