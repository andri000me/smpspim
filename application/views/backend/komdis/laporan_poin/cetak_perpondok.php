...
if (!isset($PONDOK)) {
    echo '<h1>TIDAK DAPAT MENCETAK SELURUH PONDOK</h1>';
    exit();
}
...
foreach ($DATA as $DETAIL) {
    if($DETAIL->ID_KJT == 1) $jumlah_sp++;
    elseif($DETAIL->ID_KJT == 2) $jumlah_po_1++;
    elseif($DETAIL->ID_KJT == 3) $jumlah_po_2++;
    elseif($DETAIL->ID_KJT == 4) $jumlah_takliq++;
