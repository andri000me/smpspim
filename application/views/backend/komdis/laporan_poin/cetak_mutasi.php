...
//	$pdf->SetMargins(6, 0);
    ...
    $pdf->MultiCell(0, 5, 'Dengan ini kami dari Komisi Disiplin Siswa Perguruan Islam Mathali\'ul Falah, merekomendasikan siswa terlampir untuk mendapatkan Sanksi dan Pembinaan berupa PENCABUTAN HAK SEBAGAI SISWA SECARA TETAP karena pelanggaran yang telah dilakukan siswa tersebut sampai pada hari ini telah memiliki akumulasi ' . $POIN_MIN . ' poin . Hal ini sesuai dengan Tata Tertib Siswa Perguruan Islam Mathali\'ul Falah Tahun 2010 tentang Pembinaan dan Sanksi Pasal 10 dan 11 poin d Bab III Peraturan Pelengkap yang berbunyi : "Dicabut seluruh haknya sebagai siswa secara tetap, jika akumulasi skor pelanggaran telah mencapai 100 poin".');
    $pdf->Ln();
...
//	$pdf->SetMargins(6, 0);
    ...
    $pdf->MultiCell(0, 5, 'Dengan ini kami dari Komisi Disiplin Siswa Perguruan Islam Mathali\'ul Falah, merekomendasikan siswa terlampir untuk mendapatkan Sanksi dan Pembinaan berupa PENCABUTAN HAK SEBAGAI SISWA SECARA TETAP karena pelanggaran yang telah dilakukan siswa tersebut sampai pada hari ini telah memiliki akumulasi poin 100. Hal ini sesuai dengan Tata Tertib Siswa Perguruan Islam Mathali\'ul Falah Tahun 2010 tentang Pembinaan dan Sanksi Pasal 10 dan 11 poin d Bab III Peraturan Pelengkap yang berbunyi : "Dicabut seluruh haknya sebagai siswa secara tetap, jika akumulasi skor pelanggaran telah mencapai 100 poin".');
    $pdf->Ln();
