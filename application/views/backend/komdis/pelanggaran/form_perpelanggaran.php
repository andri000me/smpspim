...
$subtitle = "Tambah perlanggaran persiswa";
...
<script type="text/javascript">
    ...
    function buka_siswa() {
        ...
        if (TANGGAL_PELANGGARAN === '' || PELANGGARAN_KS === null || SUMBER_KS === null) {
            ...
            table = initialize_datatables(id_table, '<?php echo site_url('komdis/pelanggaran/ajax_list_perpelanggaran'); ?>/' + TANGGAL_PELANGGARAN + '/' + PELANGGARAN_KS, columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    ...
    function simpan_pelanggaran(that) {
        ...
        if(parseInt(STATUS))
            create_ajax('<?php echo site_url('komdis/pelanggaran/ajax_add'); ?>', 'TANGGAL_KS=' + TANGGAL_PELANGGARAN + '&PELANGGARAN_KS=' + PELANGGARAN_KS + '&SUMBER_KS=' + SUMBER_KS + '&STATUS=' + STATUS + '&SISWA_KS=' + ID + '&KETERANGAN_KS=', success);
        else
            create_ajax('<?php echo site_url('komdis/pelanggaran/ajax_delete'); ?>', 'ID=' + ID, success);
    }
</script>