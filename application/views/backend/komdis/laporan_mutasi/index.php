<?php
$title = 'Laporan Poin Siswa Mutasi';
$subtitle = "Daftar semua poin pelanggaran siswa mutasi";
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = initialize_datatables(id_table, '<?php echo site_url('komdis/laporan_mutasi/ajax_list'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
...
//        $('').insertAfter('.buttons-reload');
    ...
    function cetak_modal_kelas() {
        ...
        window.open('<?php echo site_url('komdis/laporan_mutasi/cetak_perkelas'); ?>?KELAS=' + checkbox_kelas, '_blank');
    ...
    function cetak_siswa_multi() {
        if (checkbox_siswa.length > 0)
            window.open('<?php echo site_url('komdis/laporan_mutasi/cetak_siswa_multi'); ?>?ID_KSH=' + checkbox_siswa, '_blank');
        else
    ...
    function cetak(ID_KSH) {
        window.open('<?php echo site_url('komdis/laporan_mutasi/cetak'); ?>/' + ID_KSH, '_blank');
    }
