<?php
$title = 'Tambah Pelanggaran Catatan dengan Barcode';
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading hbuilt">
                    Form Tambah Pelanggaran Catatan dengan Scanner Barcode
                </div>
...
//        table = initialize_datatables(id_table, '<?php echo site_url('komdis/absen_jamaah/ajax_list_siswa/'); ?>', columns, orders, functionInitComplete, functionDrawCallback, functionAddData, requestExport);
    ...
    function get_data_scanner(NIS_SISWA) {
        ...
        if (TANGGAL_KS === '' || PELANGGARAN_KS === null || SUMBER_KS === null)
            ...
            create_ajax('<?php echo site_url('komdis/pelanggaran_catatan/get_data_scanner'); ?>', 'NIS_SISWA=' + NIS_SISWA + '&TANGGAL_KS=' + TANGGAL_KS + '&PELANGGARAN_KS=' + PELANGGARAN_KS + '&SUMBER_KS=' + SUMBER_KS, success);
    }
</script>