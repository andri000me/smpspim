...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".buttons-add").remove();
        $('<div class="btn-group"><button data-toggle="dropdown" class="btn btn-default btn-sm dropdown-toggle">Tambah <span class="caret"></span></button><ul class="dropdown-menu"><li><a href="#" onclick="add_individu();" >Pelanggaran Persiswa</a></li><!--<li><a href="<?php echo site_url('komdis/pelanggaran_catatan/form'); ?>" target="_blank">Pelanggaran dengan Barcode</a></li>--></ul></div>').insertAfter('.buttons-reload');
    });
