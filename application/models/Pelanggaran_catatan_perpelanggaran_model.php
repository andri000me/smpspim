...
class Pelanggaran_catatan_perpelanggaran_model extends CI_Model {
    ...
    private function _get_table($TANGGAL_PELANGGARAN, $PELANGGARAN_KS) {
        ...
        $this->db->join('(SELECT * FROM komdis_siswa_catatan WHERE PELANGGARAN_KS=' . $PELANGGARAN_KS . ' AND TANGGAL_KS="' . $TANGGAL_PELANGGARAN . '") ks', 'ks.SISWA_KS=ms.ID_SISWA AND ks.TA_KS=TA_AS', 'LEFT');
