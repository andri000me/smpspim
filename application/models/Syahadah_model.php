...
class Syahadah_model extends CI_Model {

    var $table = 'akad_siswa';
    var $column = array('NIS_SISWA','NO_ABSEN_AS', 'NAMA_SISWA','NAMA_SISWA','AYAH_NAMA_SISWA','AYAH_NAMA_SISWA','JK_SISWA','KETERANGAN_TINGK','NAMA_KELAS', 'NAMA_PEG', 'ID_AS');
