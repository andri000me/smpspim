...
class Asal_sekolah_model extends CI_Model {
    ...
    var $table = 'md_asal_sekolah';
    var $column = array('NAMA_JS', 'NAMA_AS', 'NAMA_KEC', 'NAMA_KAB', 'NAMA_PROV', 'ID_AS');
    ...
    private function _get_table() {
        ...
        $this->db->join('md_jenjang_sekolah js', $this->table.'.JENJANG_AS=js.ID_JS');
        $this->db->join('md_kecamatan kec', $this->table.'.KECAMATAN_AS=kec.ID_KEC');
    ...
    public function get_all($for_html = true) {
        if ($for_html) $this->db->select("ID_AS as id, CONCAT(NAMA_JS, ' - ',NAMA_AS, ', Kecamatan ',NAMA_KEC, ', ',NAMA_KAB, ', ',NAMA_PROV) as text");
        $this->_get_table();
